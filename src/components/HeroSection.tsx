...
From morocco to the world
        ...
        >
          ...
          <span className="text-gold-gradient">and its what we bring you and your client</span>
        </motion.h1>
        ...
        >
         Built different. Seen everywhere.
        </motion.p>
        ...
        {/* <motion.a
          ...
          className="inline-block bg-gold-gradient text-primary-foreground font-body font-semibold tracking-wider uppercase text-sm px-10 py-4 rounded-sm glow-gold hover:glow-gold transition-shadow duration-500"
        >
          Get Started
        </motion.a> */}
      </div>
